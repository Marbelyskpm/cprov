		        ...
		        <form action="" method="post" class="form-horizontal">
		          <div class="form-group">
					...
					<div class="form-group">
			            ...
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el apellido de la persona" name="cedula" type="text">
			            </div>
			        </div>
					<div class="form-group">
			            <label class="control-label col-md-2">Rif</label>
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el usuario de la persona" name="rif" type="text">
			            </div>
			        </div>
					<div class="form-group">
