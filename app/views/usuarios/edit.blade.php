              ...
              <div class="widget-content padded">
		        <form action="" method="post" class="form-horizontal">
		          <div class="form-group">
			            ...
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el nombre de la persona" name="nombre" type="text" value="{{ $usuario->nombre }}"/>
			            </div>
			        </div>
					<div class="form-group">
			            <label class="control-label col-md-2">Apellido</label>
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el apellido de la persona" name="apellido" type="text" value="{{ $usuario->apellido }}">
			            </div>
			        </div>
					<div class="form-group">
			            <label class="control-label col-md-2">Usuario</label>
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el usuario de la persona" name="username" type="text" value="{{ $usuario->username }}">
			            </div>
			        </div>
